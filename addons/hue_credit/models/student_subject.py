...
class StudentSubjects(models.Model):
    ...
    student_semester_id = fields.Many2one('op.student.accumlative.semesters', string='Student Semester',
                                          ondelete='cascade')
    ...
    academicyear_seq = fields.Integer(related='academicyear_id.sequence')
    semester_seq = fields.Integer(related='semester_id.sequence')
    ...
    # grade_quiz = fields.Float('QuizDegree') #commented in odoo 11
    ...
    # student_status = fields.Char('Student Status', related='student_semester_id.semester_status', readonly=True) #commented in odoo 11 
